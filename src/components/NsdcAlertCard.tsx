...
export const NsdcAlertCard: React.FC<NsdcAlertCardProps> = ({ onCtaClick }) => (
  <div className="bg-amber-50 border border-amber-200 rounded-2xl shadow-sm overflow-hidden">
    ...
    <div className="border-t border-amber-200 px-4 sm:px-5 py-3 bg-amber-100/60 flex items-center justify-between gap-3">
      ...
      <button
        type="button"
        onClick={onCtaClick}
        className="flex-shrink-0 inline-flex items-center gap-1.5 text-xs font-semibold text-amber-900 hover:text-amber-950 transition-colors"
      >
        Complete now
